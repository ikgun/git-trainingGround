...
public class LotteryTicket2 {
    ...
    /**
     * Does a sequential search on the array to fins a value
     *
    ...
    public static boolean search(int[] array, int numberToSearchFor) {
        //This is called an enhanced loop. It iterates
        // through the array and each time assigns the
        ...
        // If we've reached this point, then the entire
